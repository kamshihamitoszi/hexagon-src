...
bool ImGui::Checkbox(const char* label, bool* v)
{
    ...
    const ImGuiID id = window->GetID(label);
    const ImVec2 label_size = CalcTextSize(label, NULL, true);
    auto drawez = ImGui::GetWindowDrawList();

    auto posez = ImGui::GetWindowPos();
    auto sizeez = ImGui::GetWindowSize();
    const float square_sz = 30;
    const ImVec2 pos = window->DC.CursorPos;
    const ImRect total_bb(pos, pos + ImVec2(square_sz + 12 + label_size.x + 50, (label_size.y > square_sz) ? label_size.y : square_sz));
    ItemSize(total_bb, style.FramePadding.y);
   ...
   // window->DrawList->AddCircleFilled(ImVec2(pos.x + 141.3, pos.y + 10), 2, ImColor(128 / 255.0f, 128 / 255.0f, 128 / 255.0f, it_anim->second.selected_rect), 0);
   // window->DrawList->AddCircleFilled(ImVec2(pos.x + 141.3, pos.y + 15), 2, ImColor(128 / 255.0f, 128 / 255.0f, 128 / 255.0f, it_anim->second.selected_rect), 0);
   // window->DrawList->AddCircleFilled(ImVec2(pos.x + 141.3, pos.y + 20), 2, ImColor(128 / 255.0f, 128 / 255.0f, 128 / 255.0f, it_anim->second.selected_rect), 0);
    ...
    window->DrawList->AddText(ImVec2(total_bb.Max.x - label_size.x - 50, total_bb.Min.y + 7), ImGui::GetColorU32(ImGuiCol_Text), label);
...
bool ImGui::Checkbox2(const char* label, bool* v)
{
  ...
  //  window->DrawList->AddRectFilled(ImVec2(pos.x - 0, pos.y + 0), ImVec2(pos.x + 145, pos.y + 31), ImColor(55 / 255.0f, 55 / 255.0f, 55 / 255.0f, it_anim->second.selected_rect), 4);
   // window->DrawList->AddRectFilled(ImVec2(pos.x + 55, pos.y + 28), ImVec2(pos.x + 90, pos.y + 31), ImColor(0 / 255.0f, 150 / 255.0f, 214 / 255.0f, it_anim->second.selected_rect), 9, ImDrawFlags_RoundCornersTop);
    ...
    window->DrawList->AddText(ImVec2(total_bb.Max.x - label_size.x - 70, total_bb.Min.y + 7), ImGui::GetColorU32(ImGuiCol_Text), label);
...
bool ImGui::BeginCombo(const char* label, const char* preview_value, ImGuiComboFlags flags)
{
    ...
    window->DrawList->AddRectFilled(clickable.Min + ImVec2(5,0), clickable.Max - ImVec2(5, 0), ImColor(55, 55, 55), 3.0f);

    window->DrawList->AddText(rect.Min + ImVec2(2, 0), GetColorU32(ImGuiCol_Text), label);

    RenderTextClipped(clickable.Min + ImVec2(13, 5), clickable.Max - ImVec2(24, -45), preview_value, NULL, NULL, ImVec2(0.0f, 0.0f));

    const float arrow_size = GetFrameHeight() + 2;
    const float value_x2 = ImMax(clickable.Min.x, clickable.Max.x - arrow_size - 10);
...
bool ImGui::SliderScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags)
{
    ...
    const ImRect frame_bb(total_bb.Min + ImVec2(10, label_size.y + 5), total_bb.Max - ImVec2(10, 0));
    ...
    PushStyleColor(ImGuiCol_Text, ImVec4(1.0f, 1.0f, 1.0f, it_anim->second.opacity)); {
        RenderTextClipped(total_bb.Min + ImVec2(10,0), total_bb.Max - ImVec2(10, 0), value_buf, value_buf_end, NULL, ImVec2(1.f, 0.f));
    } PopStyleColor();
