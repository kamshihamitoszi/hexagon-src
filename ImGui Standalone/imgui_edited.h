...
namespace edited
{
    bool            BeginChild(ImGuiID id, const ImVec2& size = ImVec2(0, 0), ImGuiWindowFlags window_flags = 0);
    bool            BeginChild(const char* str_id, const ImVec2& size = ImVec2(0, 0), ImGuiWindowFlags window_flags = 0);
    void            EndChild();
    bool            BeginChildEx(const char* name, ImGuiID id, const ImVec2& size_arg, ImGuiWindowFlags window_flags);
